      ...
      <ul class="space-y-1 px-2">
        ...
        <li>
          ...
          >
            ...
            <svg :class="['w-4 h-4 transition-transform', menuOpen.services ? 'rotate-90' : '']" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
            </svg>
          </button>
          <ul v-show="menuOpen.services" class="mt-1 ml-4 space-y-1">
            <li>
        ...
        <li>
          ...
          >
            ...
            <svg :class="['w-4 h-4 transition-transform', menuOpen.users ? 'rotate-90' : '']" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
            </svg>
          </button>
          <ul v-show="menuOpen.users" class="mt-1 ml-4 space-y-1">
            <li>
              <a href="#" class="flex items-center px-3 py-2 rounded text-sm hover:bg-[#495057]">
                <span class="w-1.5 h-1.5 bg-[#6c757d] rounded-full mr-3"></span>
                Mijozlar
        ...
        <li>
          <a href="#" class="flex items-center px-3 py-2 rounded text-sm hover:bg-[#495057] transition-colors">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
