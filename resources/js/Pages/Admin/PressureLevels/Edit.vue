...
const submit = () => {
  form.patch(route('admin.pressure-levels.update', props.pressureLevel.id), {
    preserveScroll: true,
  });
};
    ...
    <div class="mb-4">
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p class="text-sm text-[#6c757d] mt-1">{{ pressureLevel.uz?.name || pressureLevel.en?.name }}</p>
        </div>
            ...
            <div class="p-4">
              ...
              <div class="flex gap-2">
                <button type="submit" :disabled="form.processing"
                  class="flex-1 inline-flex items-center justify-center px-4 py-2 bg-[#ffc107] text-[#1f2d3d] text-sm font-medium rounded hover:bg-[#e0a800] transition disabled:opacity-50">
