  ...
  <div>
    ...
    <div class="mb-4">
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 class="text-2xl font-semibold text-[#1f2d3d]">{{ t('standardItems.new') }}</h1>
          <p class="text-sm text-[#6c757d] mt-1">{{ t('common.create') }} {{ t('standardItems.singular').toLowerCase() }}</p>
        </div>
        ...
        <div class="lg:col-span-2 space-y-4">
          ...
          <div class="bg-white rounded shadow-sm">
            <div class="px-4 py-3 border-b border-gray-200 bg-[#17a2b8] rounded-t">
              <h3 class="font-semibold text-white">{{ t('translations.title') }}</h3>
            </div>
          ...
          <div class="bg-white rounded shadow-sm">
            ...
            <div class="p-4">
              <input
                ...
                placeholder="🧺"
              />
              <p class="text-xs text-[#6c757d] mt-1">{{ t('standardItems.iconHint') }}</p>
            </div>
          </div>
