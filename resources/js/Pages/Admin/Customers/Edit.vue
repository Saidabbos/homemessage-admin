  ...
  <div>
    ...
    <div class="mb-4">
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 class="text-2xl font-semibold text-[#1f2d3d]">{{ t('customers.edit') }}</h1>
          <p class="text-sm text-[#6c757d] mt-1">{{ customer.name }}</p>
        </div>
        ...
        <div class="lg:col-span-2 space-y-4">
          ...
          <div class="bg-white rounded shadow-sm">
            <div class="px-4 py-3 border-b border-gray-200 bg-[#ffc107] rounded-t">
              <h3 class="font-semibold text-[#1f2d3d]">{{ t('customers.personalInfo') }}</h3>
            </div>
            <div class="p-4 space-y-4">
              <!-- Name -->
              <div>
                <label class="block text-sm font-medium text-[#1f2d3d] mb-1">
                  {{ t('customers.name') }} <span class="text-[#dc3545]">*</span>
                </label>
                <input
                  type="text"
                  v-model="form.name"
              ...
              <div>
                <label class="block text-sm font-medium text-[#1f2d3d] mb-1">
                  {{ t('customers.email') }} <span class="text-[#dc3545]">*</span>
                </label>
                <input
                  type="email"
                  v-model="form.email"
        ...
        <div class="space-y-4">
          ...
          <div class="bg-white rounded shadow-sm">
            ...
            <div class="p-4">
              ...
              <p class="text-xs text-[#6c757d] mt-2">{{ t('customers.statusHint') }}</p>
            </div>
          </div>
