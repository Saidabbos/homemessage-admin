...
<template>
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-2xl font-bold tracking-tight">{{ t('customers.title') }}</h1>
    ...
    <Card>
      ...
      <CardContent class="p-0">
        <Table v-if="customers.data.length > 0">
          ...
          <TableBody>
            <TableRow v-for="(customer, index) in customers.data" :key="customer.id">
              ...
              <TableCell class="text-muted-foreground">{{ formatDate(customer.created_at) }}</TableCell>
              <TableCell>
                <Badge v-if="customer.status" class="bg-green-500/10 text-green-700">
                  {{ t('common.active') }}
                </Badge>
              ...
              <TableCell>
                <div class="flex items-center justify-center gap-1">
                  ...
                  <Button variant="ghost" size="icon" @click="deleteCustomer(customer.id)">
        ...
        <div v-else class="flex flex-col items-center justify-center py-12">
          ...
          <p class="text-muted-foreground">{{ t('customers.emptyMessage') }}</p>
        </div>
      </CardContent>

      <!-- Pagination -->
      <div v-if="customers.data.length > 0" class="flex items-center justify-between px-6 py-4 border-t">
