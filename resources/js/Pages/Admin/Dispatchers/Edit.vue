  ...
  <div>
    ...
    <div class="mb-4">
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 class="text-2xl font-semibold text-[#1f2d3d]">{{ t('dispatchers.edit') }}</h1>
          <p class="text-sm text-[#6c757d] mt-1">{{ dispatcher.name }}</p>
        </div>
        ...
        <div class="lg:col-span-2 space-y-4">
          ...
          <div class="bg-white rounded shadow-sm">
            <div class="px-4 py-3 border-b border-gray-200 bg-[#ffc107] rounded-t">
              <h3 class="font-semibold text-[#1f2d3d]">{{ t('dispatchers.personalInfo') }}</h3>
            </div>
            <div class="p-4 space-y-4">
              ...
              <div>
                <label class="block text-sm font-medium text-[#1f2d3d] mb-1">
                  {{ t('dispatchers.password') }}
                </label>
                <input
                  type="password"
                  v-model="form.password"
                  class="w-full px-3 py-2 border border-gray-300 rounded focus:ring-[#007bff] focus:border-[#007bff] text-sm"
                  :placeholder="t('dispatchers.leaveEmpty')"
                />
                <p class="text-xs text-[#6c757d] mt-1">{{ t('dispatchers.passwordHint') }}</p>
