...
const form = useForm({
  ...
  uz: { ...props.testimonial.uz },
  ru: { ...props.testimonial.ru },
  en: { ...props.testimonial.en },
});
  ...
  <div>
    ...
    <div class="mb-4">
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 class="text-2xl font-semibold text-[#1f2d3d]">{{ t('testimonials.edit') }}</h1>
          <p class="text-sm text-[#6c757d] mt-1">{{ t('common.edit') }} {{ t('testimonials.singular').toLowerCase() }}</p>
        </div>
