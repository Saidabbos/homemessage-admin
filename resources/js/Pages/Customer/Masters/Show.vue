                    ...
                    <div class="cms-hero-info">
                        <div class="cms-hero-top">
                            ...
                            <button class="cms-fav-btn" :class="{ active: master.is_favorite }" @click="toggleFavorite">
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" :fill="master.is_favorite ? '#C8A65E' : 'none'" :stroke="master.is_favorite ? '#C8A65E' : 'currentColor'" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/></svg>
                            </button>
                        </div>
                        ...
                        <div class="cms-stats">
                            ...
                            <div class="cms-stat-item">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="#C8A65E" stroke="#C8A65E" stroke-width="2"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>
                                <div>
