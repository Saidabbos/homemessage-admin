        ...
        <div class="rf-container">
            ...
            <div class="rf-card">
                <form @submit.prevent="submit">
                    ...
                    <!-- Sub Ratings -->
                    <div class="rf-sub-ratings">
                        <div class="rf-section">
                            <label class="rf-label-sm">{{ t('rating.punctuality') }}</label>
                        ...
                        <div class="rf-section">
                            <label class="rf-label-sm">{{ t('rating.professionalism') }}</label>
                            <div class="rf-stars rf-stars-sm">
                                <button
                                    v-for="star in 5"
                                    :key="star"
                                    type="button"
                                    class="rf-star rf-star-sm"
                                    :class="{ 'rf-star-filled': star <= (hoveredRating.professionalism || form.professionalism_rating) }"
                        ...
                        <div class="rf-section">
                            <label class="rf-label-sm">{{ t('rating.cleanliness') }}</label>
                            <div class="rf-stars rf-stars-sm">
                                <button
                                    v-for="star in 5"
                                    :key="star"
                                    type="button"
                                    class="rf-star rf-star-sm"
                                    :class="{ 'rf-star-filled': star <= (hoveredRating.cleanliness || form.cleanliness_rating) }"
                    ...
                    <button
                        type="submit"
                        class="rf-submit rf-submit-customer"
